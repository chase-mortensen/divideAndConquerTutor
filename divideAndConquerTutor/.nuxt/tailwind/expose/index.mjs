...
import daisyui from "#build/tailwind/expose/daisyui.mjs"
...
const config = { theme, corePlugins, plugins, content, daisyui, presets, darkMode, prefix, important, separator, safelist, blocklist }
export { config as default, theme, corePlugins, plugins, content, daisyui, presets, darkMode, prefix, important, separator, safelist, blocklist }